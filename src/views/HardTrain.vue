...
export default {
  ...
  methods: {
    ...
    genExercice(){
      ...
      let fourth = this.genNumber(Exercices.exercicesSix.length);
      this.exerciceFour = Exercices.exercicesSix[fourth];

      let fifth = this.genNumber(Exercices.exercicesThree.length);
      this.exerciceFive = Exercices.exercicesThree[fifth];
    },
    reload() {
      location.reload();
    }
